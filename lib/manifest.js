...
function parseManifest(value) {
	...
	} else if (commitId !== void 0) corrupt("sqlite 后端的恢复点不应携带 commitId");
	...
	const partial = record.partial === void 0 ? void 0 : record.partial;
	if (partial !== void 0 && partial !== true) corrupt("partial 只能为 true");
	...
	if (restoreKind === "turn") {
		...
		if (sessionId === void 0 || messageSeq === void 0) corrupt("message 恢复点必须携带 sessionId 与 messageSeq");
		if (turn === void 0 || turnStartSeq === void 0) corrupt("message 恢复点必须携带回合元数据（turn/turnStartSeq）");
		...
		if (messageSeq !== void 0) corrupt("只有 message 恢复点可以携带 messageSeq");
		if (partial !== void 0) corrupt("只有 message 恢复点可以是部分树");
		if (createdPaths !== void 0) corrupt("只有部分树可以携带 createdPaths");
	}
	if (record.intent !== void 0) {
	...
	return {
		...
		...createdPaths === void 0 ? {} : { createdPaths },
		createdAt,
		treeHash,
		fileCount,
		totalBytes,
...
function parseCreatedPaths(value) {
	if (value === void 0) return void 0;
...
//#endregion
export { diffTrees, entriesEqual, hashTree, makeId, parseManifest, sha256Hex };
