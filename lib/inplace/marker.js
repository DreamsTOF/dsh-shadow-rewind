...
const INPLACE_MARKER_PLUGIN = "dsh-shadow-rewind";
/** 空内容标记（append 时禁止复用同一引用，避免宿主修改污染常量）。 */
const INPLACE_MARKER_CONTENT = [];
/** 构造一条可 append 的标记消息体（每次新对象）。 */
function buildInPlaceMarker() {
	return {
...
//#endregion
export { INPLACE_MARKER_CONTENT, INPLACE_MARKER_PLUGIN, buildInPlaceMarker };
