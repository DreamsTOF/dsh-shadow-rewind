...
export declare const zh: {
    ...
    readonly snapshotDialogWarn: "整树恢复会把工作区全部文件恢复到第 {n} 轮开始之前——包括你在这轮里自己手动做的修改，影响范围不止下面列出的文件；已记录的块级撤销状态可能随之失效（显示为冲突）。";
    ...
    readonly modeSymmetricHint: "默认只勾选本会话改动的文件；勾选其它文件会把它们一并恢复到该时点。";
