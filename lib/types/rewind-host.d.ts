 ...
 *  - ./host/fs-changes.ts     行数统计 + 轮配对 diff + 会话累计 + 窗口归属；
 ...
 *  - ./host/manage-endpoints.ts 配置/管理端点（1.3、三）；
 *  - ./host/endpoints.ts      同源 HTTP 端点的注册与 handler；
 *  - ./host/inplace-http.ts   就地遮蔽回退端点。
 */
...
export { executeInPlaceMask, handleInPlaceHttp } from './host/inplace-http.js';
export type { InPlaceAgentLike, InPlaceMaskOutcome } from './host/inplace-http.js';
...
export { sessionEvents, } from './host/types.js';
export type { AgentFace, HostContext, HostSessionCore, HostSessionLike, PreStepData, RewindHttpDeps, SessionControllerLike, SessionEventFace, SessionFace, SessionLogEvent, SessionLogSnapshotLike, } from './host/types.js';
