...
export declare function isHumanUserMessage(event: InPlaceTargetLike): boolean;
/** 期望的失败码，映射到简洁的用户文案。 */
export type InPlaceErrorCode = 'NO_USER_MESSAGES' | 'NOT_A_USER_MESSAGE' | 'NOT_ON_SURFACE';
/** 就地回退规划的失败。 */
export declare class InPlacePlanError extends Error {
    readonly code: InPlaceErrorCode;
    constructor(code: InPlaceErrorCode, message: string, options?: {
 ...
 */
export declare function planInPlace(options: InPlacePlanOptions): InPlacePlan;
/**
