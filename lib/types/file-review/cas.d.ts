...
export declare function restoreNewlines(text: string, crlf: boolean): string;
/** 从文件字节判断行尾风格。 */
export declare function crlfStyle(bytes: Uint8Array): boolean;
/** 统一内容比较：两个文件字节在 LF 归一后是否等价。 */
export declare function contentMatches(currentBytes: Uint8Array, expectedBytes: Uint8Array): boolean;
