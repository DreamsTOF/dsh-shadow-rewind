		...
		if (request.method === "GET") {
			...
			if (checkpoint.turn !== void 0) {
				...
				if (sessionIdForLookup) {
					...
					const nextCheckpoint = currentIndex >= 0 ? allCheckpoints[currentIndex + 1] : void 0;
					if (nextCheckpoint !== void 0) {
...
async function handleFsChangesHttp(deps, engine, request, response) {
	try {
		...
		if (last !== void 0 && last.turn !== void 0 && last.turnStartSeq !== void 0) try {
