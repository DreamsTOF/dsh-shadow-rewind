...
/** 预览响应默认带出的变更条数（分页首屏）。 */
export const INITIAL_CHANGE_PREVIEW_LIMIT = 8
...
export function json(response: Response, status: number, value: unknown): void {
...
export function pageSize(value: string | null, fallback: number): number {
